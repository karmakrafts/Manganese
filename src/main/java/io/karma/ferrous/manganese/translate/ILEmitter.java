 ...
 * @since 11/10/2023
 */
public class ILEmitter implements FerrousParserListener {
    @Override
    ...
    @Override
    public void enterTryStatement(TryStatementContext tryStatementContext) {

    }

    @Override
    public void exitTryStatement(TryStatementContext tryStatementContext) {

    }

    @Override
    public void enterTryCatchStatement(TryCatchStatementContext tryCatchStatementContext) {

    }

    @Override
    public void exitTryCatchStatement(TryCatchStatementContext tryCatchStatementContext) {

    }

    @Override
    public void enterTryWithStatement(TryWithStatementContext tryWithStatementContext) {

    }

    @Override
    public void exitTryWithStatement(TryWithStatementContext tryWithStatementContext) {

    }

    @Override
    public void enterCatchBlock(CatchBlockContext catchBlockContext) {

    }

    @Override
    public void exitCatchBlock(CatchBlockContext catchBlockContext) {
